...
Record IsDiffeomorphic (M1 M2 : Manifold3) := mkIsDiffeomorphic {
  diffeo_map : sm_type M1 -> sm_type M2;
  diffeo_inv : sm_type M2 -> sm_type M1;
  diffeo_cont : Continuous (sm_type M1) (sm_type M2) (sm_toplogy M1) (sm_toplogy M2) diffeo_map;
  diffeo_inv_cont : Continuous (sm_type M2) (sm_type M1) (sm_toplogy M2) (sm_toplogy M1) diffeo_inv;
...
Axiom positive_curvature_sphere :
  forall (M : Manifold3) (g : RiemannianMetric M),
    ...
    exists (phi : sm_type M -> sm_type M),
...
Lemma diffeomorphic_implies_homeomorphic :
  forall (M1 M2 : Manifold3),
    ...
    IsHomeomorphic (sm_type M1) (sm_type M2) (sm_toplogy M1) (sm_toplogy M2).
Proof.
  ...
  apply (mkIsHomeomorphic (sm_type M1) (sm_type M2) (sm_toplogy M1) (sm_toplogy M2) diffeo_map0 diffeo_inv0 diffeo_cont0 diffeo_inv_cont0).
Qed.
