...
(* 风格: Record + Parameter + Axiom, 与 SphereClassification 一致. *)
...
Record RicciLowerBound (M : Manifold3) (g : RiemannianMetric M) (k : R) := mkRicciLowerBound {
  ...
  ricci_bound_condition :
    forall (p : sm_type M) (v : TangentSpaceType_of M),
...
Axiom sphere_diameter_estimate :
  forall (M : Manifold3) (g3 : RiemannianMetric M),
    diameter M g3 <= PI.
