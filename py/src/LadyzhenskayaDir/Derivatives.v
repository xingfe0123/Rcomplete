...
From LadyzhenskayaDir Require Import HolderSpace ParabolicCoefficients.
...
Proof.
  ...
  split.
  - exists R0, R0, R0. split.
    + (* partial_t u p R0 *) admit.
    + split.
      + (* partial_xi2 u p R1 R0 *) admit.
      + (* partial_xi u p R1 R0 *) admit.
  (* 省略详细证明: 使用偏导数线性性 Axiom 直接拼装 *)
  admit.
Admitted.
