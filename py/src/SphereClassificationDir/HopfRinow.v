...
Definition CauchySeqM (M : Manifold3) (g : RiemannianMetric M) (s : nat -> space_type (sm_space M)) : Prop :=
...
Definition is_metric_complete (M : Manifold3) (g : RiemannianMetric M) : Prop :=
  forall s : nat -> space_type (sm_space M),
    CauchySeqM M g s -> exists lim : space_type (sm_space M), True.
...
Definition IsCompact (M : Manifold3) : Prop :=
  forall (s : nat -> space_type (sm_space M)),
    exists subseq : nat -> nat,
      ...
      exists lim : space_type (sm_space M),
        True.
