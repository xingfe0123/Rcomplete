...
Require Import Ladyzhenskaya.CaccioppoliDeGiorgiSobolev.
...
Axiom sobolev_embedding_with_domain_size :
  forall (n : nat) (Omega : Type) (u : Omega -> R) (p : R) (radius : R),
  (* Omega is a subset of a ball of given radius *)
  (* Sobolev embedding with explicit radius dependence *)
  (1 <= p)%R -> (p < INR n)%R -> (0 < radius)%R ->
  True.
